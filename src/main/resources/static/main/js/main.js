...
function sojuRandomFood() {
	...
	const html = '<div class="sulimages" style="color:black; font-weight:bold;"/>';
	const sulimage11 = '<a href="#" onclick="recommand1()"><img id="sulimage1" style="width: 250px" src=""><br><br></a>';
	const sulimage22 = '<a href="#" onclick="recommand2()"><img id="sulimage2" style="width: 250px" src=""><br><br></a>';
	const sulimage33 = '<a href="#" onclick="recommand3()"><img id="sulimage3" style="width: 250px" src=""><br><br></a>';
	const foodBtnElement1 = document.getElementById("showFood4");
	...
	const foodBtnElement2 = document.getElementById("showFood5");
	foodBtnElement2.innerHTML = html + sulimage22 + sulFood2 + '<input id="sulFood2" type="hidden" value = {sulFood2}>';
	document.getElementById("sulFood2").value = sulFood2;
	document.getElementById("sulimage2").src=sulimage2;
	const foodBtnElement3 = document.getElementById("showFood6");
	foodBtnElement3.innerHTML = html + sulimage33 + sulFood3 + '<input id="sulFood3" type="hidden" value = {sulFood3}>';
	document.getElementById("sulFood3").value = sulFood3;
	document.getElementById("sulimage3").src=sulimage3
	$("#choiceSul").hide();
	$("#recommand").show();
	$(".showFoodsafter").show();
	$(".showFoodsbefore").hide();
}
$(function (){
	$(".showFoodsafter").hide();
})
...
function recommand2 () {
	...
	const foodBtnElemet2 = document.getElementById("showFood2");
	var sulFood2 = $("#sulFood2").val();
	foodBtnElemet2.innerHTML += '<input id="registory" type="hidden" value={registory}>'
	document.getElementById("registory").value = registory;
	console.log(registory);
	console.log(sulFood2);
	console.log($("#registory").val());
	var url = "https://map.naver.com/p/search/"+registory+"%20"+sulFood2+"?c=14.35,0,0,0,dh";
	window.open(url , "_blank");
}function recommand3 () {
	var registory = prompt("지역을 입력해주세요 ex)노원구,도봉구");
	if(registory==""){
	...
	const foodBtnElemet3 = document.getElementById("showFood3");
	var sulFood3 = $("#sulFood3").val();
	foodBtnElemet3.innerHTML += '<input id="registory" type="hidden" value={registory}>'
	document.getElementById("registory").value = registory;
	console.log(registory);
	console.log(sulFood3);
	console.log($("#registory").val());
	var url = "https://map.naver.com/p/search/"+registory+"%20"+sulFood3+"?c=14.35,0,0,0,dh";
	window.open(url , "_blank");
}
